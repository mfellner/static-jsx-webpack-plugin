...
StaticReactSource.prototype.source = function() {
  ...
  // ES2015 modules with a 'default export' yield a 'exports.default = MyClass'
  // statement as opposed to CommonJS modules, which yield
  // 'module.exports = MyClass'. In the first case, the interpreted script
  // produces an object with a 'default' property. In the second case it
  // directly returns the exported function/object.
